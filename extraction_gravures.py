...
parser.add_argument('--xml', default='ocr', type=str, help="Le chemin du dossier des fichiers xml à charger.")
args = parser.parse_args()

list_images = os.listdir(args.image)
list_file_xml = os.listdir(args.xml)

for filename in list_file_xml:
    xml_path = os.path.join(args.xml, filename)  # Chemin vers les fichiers .xml
    label, ext = os.path.splitext(filename)  # Récupération du nom sans l'extension
